...
namespace RC::Unreal
{
    auto Flags412::to_impl_flags(const EObjectFlags flags) -> EObjectFlags_Impl
    {
        ...
        //if ((flags & EObjectFlags::RF_NeedInitialization) != 0) flags_impl |= EObjectFlags_Impl::RF_NeedInitialization; // Not present in 4.12
        if ((flags & EObjectFlags::RF_NeedLoad) != 0) flags_impl |= EObjectFlags_Impl::RF_NeedLoad;
        //if ((flags & EObjectFlags::RF_KeepForCooker) != 0) flags_impl |= EObjectFlags_Impl::RF_KeepForCooker; // Not present in 4.12
        ...
        //if ((flags & EObjectFlags::RF_NewerVersionExists) != 0) flags_impl |= EObjectFlags_Impl::RF_NewerVersionExists; // Not present in 4.12
        ...
        //if ((flags & EObjectFlags::RF_DuplicateTransient) != 0) flags_impl |= EObjectFlags_Impl::RF_DuplicateTransient; // Not present in 4.12
        if ((flags & EObjectFlags::RF_StrongRefOnFrame) != 0) flags_impl |= EObjectFlags_Impl::RF_StrongRefOnFrame;
        //if ((flags & EObjectFlags::RF_NonPIEDuplicateTransient) != 0) flags_impl |= EObjectFlags_Impl::RF_NonPIEDuplicateTransient; // Not present in 4.12
        if ((flags & EObjectFlags::RF_Dynamic) != 0) flags_impl |= EObjectFlags_Impl::RF_Dynamic;
        //if ((flags & EObjectFlags::RF_WillBeLoaded) != 0) flags_impl |= EObjectFlags_Impl::RF_WillBeLoaded; // Not present in 4.12
        //if ((flags & EObjectFlags::RF_HasExternalPackage) != 0) flags_impl |= EObjectFlags_Impl::RF_HasExternalPackage; // Not present in 4.12
