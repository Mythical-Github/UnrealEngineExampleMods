...
namespace RC::Unreal
{
    auto Flags422::to_impl_flags(const EObjectFlags flags) -> EObjectFlags_Impl
    {
        ...
        //if ((flags & EObjectFlags::RF_HasExternalPackage) != 0) flags_impl |= EObjectFlags_Impl::RF_HasExternalPackage; // Not present in 4.22
