...
namespace RC::Unreal
{
    auto Flags415::to_impl_flags(const EObjectFlags flags) -> EObjectFlags_Impl
    {
        ...
        //if ((flags & EObjectFlags::RF_WillBeLoaded) != 0) flags_impl |= EObjectFlags_Impl::RF_WillBeLoaded; // Not present in 4.15
        //if ((flags & EObjectFlags::RF_HasExternalPackage) != 0) flags_impl |= EObjectFlags_Impl::RF_HasExternalPackage; // Not present in 4.15
