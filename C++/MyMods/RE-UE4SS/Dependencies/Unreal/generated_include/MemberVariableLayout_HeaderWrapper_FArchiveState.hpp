...
public:
    uint8& GetArIsLoadingFromCookedPackage();
    const uint8& GetArIsLoadingFromCookedPackage() const;
...
public:
    uint8& GetArShouldSkipCompilingAssets();
    const uint8& GetArShouldSkipCompilingAssets() const;
...
public:
    uint8& GetArUseUnversionedPropertySerialization();
    const uint8& GetArUseUnversionedPropertySerialization() const;
