...
{
    AGameMode::VTableLayoutMap.emplace(STR("PreLogin"), 0x708);
}

if (auto it = AGameMode::VTableLayoutMap.find(STR("PreLogin_2")); it == AGameMode::VTableLayoutMap.end())
{
    AGameMode::VTableLayoutMap.emplace(STR("PreLogin_2"), 0x710);
}

if (auto it = AGameMode::VTableLayoutMap.find(STR("Login")); it == AGameMode::VTableLayoutMap.end())
{
    AGameMode::VTableLayoutMap.emplace(STR("Login"), 0x718);
}

if (auto it = AGameMode::VTableLayoutMap.find(STR("Login_2")); it == AGameMode::VTableLayoutMap.end())
{
    AGameMode::VTableLayoutMap.emplace(STR("Login_2"), 0x720);
}
...
{
    AGameMode::VTableLayoutMap.emplace(STR("InitNewPlayer"), 0x810);
}

if (auto it = AGameMode::VTableLayoutMap.find(STR("InitNewPlayer_2")); it == AGameMode::VTableLayoutMap.end())
{
    AGameMode::VTableLayoutMap.emplace(STR("InitNewPlayer_2"), 0x818);
}
