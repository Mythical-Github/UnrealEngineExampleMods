...
{
    AActor::VTableLayoutMap.emplace(STR("IsNetRelevantFor"), 0x3B8);
}

if (auto it = AActor::VTableLayoutMap.find(STR("IsNetRelevantFor_2")); it == AActor::VTableLayoutMap.end())
{
    AActor::VTableLayoutMap.emplace(STR("IsNetRelevantFor_2"), 0x3C0);
}
