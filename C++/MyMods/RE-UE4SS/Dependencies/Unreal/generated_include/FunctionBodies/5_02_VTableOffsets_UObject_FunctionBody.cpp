...
{
    UObject::VTableLayoutMap.emplace(STR("PreSaveRoot"), 0x60);
}

if (auto it = UObject::VTableLayoutMap.find(STR("PreSaveRoot_2")); it == UObject::VTableLayoutMap.end())
{
    UObject::VTableLayoutMap.emplace(STR("PreSaveRoot_2"), 0x68);
}
...
if (auto it = UObject::VTableLayoutMap.find(STR("PostSaveRoot_2")); it == UObject::VTableLayoutMap.end())
{
    UObject::VTableLayoutMap.emplace(STR("PostSaveRoot_2"), 0x78);
}

if (auto it = UObject::VTableLayoutMap.find(STR("PreSave")); it == UObject::VTableLayoutMap.end())
{
    UObject::VTableLayoutMap.emplace(STR("PreSave"), 0x80);
}

if (auto it = UObject::VTableLayoutMap.find(STR("PreSave_2")); it == UObject::VTableLayoutMap.end())
{
    UObject::VTableLayoutMap.emplace(STR("PreSave_2"), 0x88);
}
...
{
    UObject::VTableLayoutMap.emplace(STR("Serialize"), 0xC8);
}

if (auto it = UObject::VTableLayoutMap.find(STR("Serialize_2")); it == UObject::VTableLayoutMap.end())
{
    UObject::VTableLayoutMap.emplace(STR("Serialize_2"), 0xD0);
}
...
{
    UObject::VTableLayoutMap.emplace(STR("PostDuplicate"), 0xF8);
}

if (auto it = UObject::VTableLayoutMap.find(STR("PostDuplicate_2")); it == UObject::VTableLayoutMap.end())
{
    UObject::VTableLayoutMap.emplace(STR("PostDuplicate_2"), 0x100);
}
...
{
    UObject::VTableLayoutMap.emplace(STR("GetAssetRegistryTags"), 0x1B8);
}
