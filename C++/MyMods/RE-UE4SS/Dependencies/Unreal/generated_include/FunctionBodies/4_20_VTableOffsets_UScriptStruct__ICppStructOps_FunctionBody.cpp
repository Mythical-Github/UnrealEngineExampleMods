...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasNetSharedSerialization"), 0x58);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("NetSerialize"), 0x60);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasNetDeltaSerializer"), 0x68);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("NetDeltaSerialize"), 0x70);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasPostScriptConstruct"), 0x78);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("PostScriptConstruct"), 0x80);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("IsPlainOldData"), 0x88);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasCopy"), 0x90);
}

if (auto it = UScriptStruct::ICppStructOps::VTableLayoutMap.find(STR("Copy")); it == UScriptStruct::ICppStructOps::VTableLayoutMap.end())
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("Copy"), 0x98);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasIdentical"), 0xA0);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("Identical"), 0xA8);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasExportTextItem"), 0xB0);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("ExportTextItem"), 0xB8);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasImportTextItem"), 0xC0);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("ImportTextItem"), 0xC8);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasAddStructReferencedObjects"), 0xD0);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("AddStructReferencedObjects"), 0xD8);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasSerializeFromMismatchedTag"), 0xE0);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("SerializeFromMismatchedTag"), 0xE8);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasGetTypeHash"), 0xF0);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("GetTypeHash"), 0xF8);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("GetComputedPropertyFlags"), 0x100);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("IsAbstract"), 0x108);
}
