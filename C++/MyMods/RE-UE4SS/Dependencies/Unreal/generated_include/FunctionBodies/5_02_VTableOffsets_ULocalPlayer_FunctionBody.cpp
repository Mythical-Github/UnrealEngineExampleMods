...
if (auto it = ULocalPlayer::VTableLayoutMap.find(STR("GetSlateUser_2")); it == ULocalPlayer::VTableLayoutMap.end())
{
    ULocalPlayer::VTableLayoutMap.emplace(STR("GetSlateUser_2"), 0x2D0);
}
...
{
    ULocalPlayer::VTableLayoutMap.emplace(STR("PlayerAdded"), 0x2E8);
}

if (auto it = ULocalPlayer::VTableLayoutMap.find(STR("PlayerAdded_2")); it == ULocalPlayer::VTableLayoutMap.end())
{
    ULocalPlayer::VTableLayoutMap.emplace(STR("PlayerAdded_2"), 0x2F0);
}
