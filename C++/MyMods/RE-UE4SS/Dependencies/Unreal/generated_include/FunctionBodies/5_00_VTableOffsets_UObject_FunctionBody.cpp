...
{
    UObject::VTableLayoutMap.emplace(STR("PreSave_2"), 0x80);
}
...
{
    UObject::VTableLayoutMap.emplace(STR("Serialize"), 0xC0);
}

if (auto it = UObject::VTableLayoutMap.find(STR("Serialize_2")); it == UObject::VTableLayoutMap.end())
{
    UObject::VTableLayoutMap.emplace(STR("Serialize_2"), 0xC8);
}
