...
{
    UWorld::MemberOffsets.emplace(STR("ContentBundleManager"), 0x718);
}
...
if (auto it = UWorld::MemberOffsets.find(STR("IrisSystemHolder")); it == UWorld::MemberOffsets.end())
{
    UWorld::MemberOffsets.emplace(STR("IrisSystemHolder"), 0x7C8);
}
...
{
    UWorld::MemberOffsets.emplace(STR("OnWorldPartitionInitializedEvent"), 0x540);
}

if (auto it = UWorld::MemberOffsets.find(STR("OnWorldPartitionUninitializedEvent")); it == UWorld::MemberOffsets.end())
{
    UWorld::MemberOffsets.emplace(STR("OnWorldPartitionUninitializedEvent"), 0x558);
}

if (auto it = UWorld::MemberOffsets.find(STR("OriginLocation")); it == UWorld::MemberOffsets.end())
{
    UWorld::MemberOffsets.emplace(STR("OriginLocation"), 0x6D8);
}
...
{
    UWorld::MemberOffsets.emplace(STR("RequestedOriginLocation"), 0x6E4);
}
