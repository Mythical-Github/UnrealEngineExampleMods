...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("PreLogin_2"), 0x710);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("Login_2"), 0x720);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("SpawnPlayerController"), 0x738);
}

if (auto it = AGameModeBase::VTableLayoutMap.find(STR("SpawnPlayerController_2")); it == AGameModeBase::VTableLayoutMap.end())
{
    AGameModeBase::VTableLayoutMap.emplace(STR("SpawnPlayerController_2"), 0x740);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("InitNewPlayer"), 0x7A0);
}

if (auto it = AGameModeBase::VTableLayoutMap.find(STR("InitNewPlayer_2")); it == AGameModeBase::VTableLayoutMap.end())
{
    AGameModeBase::VTableLayoutMap.emplace(STR("InitNewPlayer_2"), 0x7A8);
}
