...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("SpawnPlayerController"), 0x810);
}

if (auto it = AGameModeBase::VTableLayoutMap.find(STR("SpawnPlayerController_2")); it == AGameModeBase::VTableLayoutMap.end())
{
    AGameModeBase::VTableLayoutMap.emplace(STR("SpawnPlayerController_2"), 0x818);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("ProcessClientTravel"), 0x8B0);
}

if (auto it = AGameModeBase::VTableLayoutMap.find(STR("ProcessClientTravel_2")); it == AGameModeBase::VTableLayoutMap.end())
{
    AGameModeBase::VTableLayoutMap.emplace(STR("ProcessClientTravel_2"), 0x8B8);
}
