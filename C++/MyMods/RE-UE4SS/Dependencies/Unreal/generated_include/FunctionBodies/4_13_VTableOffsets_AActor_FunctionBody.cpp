...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetPriority"), 0x320);
}

if (auto it = AActor::VTableLayoutMap.find(STR("GetNetPriority_2")); it == AActor::VTableLayoutMap.end())
{
    AActor::VTableLayoutMap.emplace(STR("GetNetPriority_2"), 0x328);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetDormancy"), 0x338);
}

if (auto it = AActor::VTableLayoutMap.find(STR("GetNetDormancy_2")); it == AActor::VTableLayoutMap.end())
{
    AActor::VTableLayoutMap.emplace(STR("GetNetDormancy_2"), 0x340);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("IsNetRelevantFor"), 0x3D0);
}

if (auto it = AActor::VTableLayoutMap.find(STR("IsNetRelevantFor_2")); it == AActor::VTableLayoutMap.end())
{
    AActor::VTableLayoutMap.emplace(STR("IsNetRelevantFor_2"), 0x3D8);
}
