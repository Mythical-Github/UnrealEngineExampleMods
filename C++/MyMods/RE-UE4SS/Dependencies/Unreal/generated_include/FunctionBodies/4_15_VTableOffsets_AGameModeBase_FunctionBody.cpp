...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("InitNewPlayer"), 0x748);
}

if (auto it = AGameModeBase::VTableLayoutMap.find(STR("InitNewPlayer_2")); it == AGameModeBase::VTableLayoutMap.end())
{
    AGameModeBase::VTableLayoutMap.emplace(STR("InitNewPlayer_2"), 0x750);
}
