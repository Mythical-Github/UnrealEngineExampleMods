...
{
    UStruct::VTableLayoutMap.emplace(STR("GetAuthoredNameForField"), 0x2E0);
}

if (auto it = UStruct::VTableLayoutMap.find(STR("GetAuthoredNameForField_2")); it == UStruct::VTableLayoutMap.end())
{
    UStruct::VTableLayoutMap.emplace(STR("GetAuthoredNameForField_2"), 0x2E8);
}
