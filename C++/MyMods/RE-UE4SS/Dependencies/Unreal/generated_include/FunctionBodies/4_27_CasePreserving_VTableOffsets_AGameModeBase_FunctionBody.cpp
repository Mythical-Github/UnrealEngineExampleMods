...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("SpawnPlayerController"), 0x770);
}

if (auto it = AGameModeBase::VTableLayoutMap.find(STR("SpawnPlayerController_2")); it == AGameModeBase::VTableLayoutMap.end())
{
    AGameModeBase::VTableLayoutMap.emplace(STR("SpawnPlayerController_2"), 0x778);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("ProcessClientTravel"), 0x800);
}

if (auto it = AGameModeBase::VTableLayoutMap.find(STR("ProcessClientTravel_2")); it == AGameModeBase::VTableLayoutMap.end())
{
    AGameModeBase::VTableLayoutMap.emplace(STR("ProcessClientTravel_2"), 0x808);
}
