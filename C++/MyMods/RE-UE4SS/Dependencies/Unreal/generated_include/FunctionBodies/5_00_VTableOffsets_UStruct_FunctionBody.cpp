...
{
    UStruct::VTableLayoutMap.emplace(STR("GetAuthoredNameForField"), 0x328);
}

if (auto it = UStruct::VTableLayoutMap.find(STR("GetAuthoredNameForField_2")); it == UStruct::VTableLayoutMap.end())
{
    UStruct::VTableLayoutMap.emplace(STR("GetAuthoredNameForField_2"), 0x330);
}
