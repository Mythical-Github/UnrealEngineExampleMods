if (auto it = FNumericProperty::VTableLayoutMap.find(STR("__vecDelDtor_6")); it == FNumericProperty::VTableLayoutMap.end())
{
    FNumericProperty::VTableLayoutMap.emplace(STR("__vecDelDtor_6"), 0x0);
}
...
{
    FNumericProperty::VTableLayoutMap.emplace(STR("SetIntPropertyValue"), 0x340);
}

if (auto it = FNumericProperty::VTableLayoutMap.find(STR("SetIntPropertyValue_2")); it == FNumericProperty::VTableLayoutMap.end())
{
    FNumericProperty::VTableLayoutMap.emplace(STR("SetIntPropertyValue_2"), 0x348);
}
