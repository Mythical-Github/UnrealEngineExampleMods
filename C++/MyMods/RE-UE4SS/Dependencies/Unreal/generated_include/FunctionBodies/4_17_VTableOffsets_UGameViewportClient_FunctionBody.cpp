...
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("AddViewportWidgetContent"), 0x258);
}
...
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("RemoveViewportWidgetContent"), 0x260);
}
...
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("AddViewportWidgetForPlayer"), 0x268);
}
...
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("PeekTravelFailureMessages"), 0x308);
}
...
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("PeekNetworkFailureMessages"), 0x310);
}
...
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("VerifyPathRenderingComponents"), 0x318);
}
