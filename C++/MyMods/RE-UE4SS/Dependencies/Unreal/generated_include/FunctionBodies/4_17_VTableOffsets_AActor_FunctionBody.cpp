...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetPriority_2"), 0x380);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetDormancy"), 0x390);
}

if (auto it = AActor::VTableLayoutMap.find(STR("GetNetDormancy_2")); it == AActor::VTableLayoutMap.end())
{
    AActor::VTableLayoutMap.emplace(STR("GetNetDormancy_2"), 0x398);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("IsNetRelevantFor_2"), 0x430);
}
