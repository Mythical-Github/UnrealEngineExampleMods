if (auto it = FNumericProperty::VTableLayoutMap.find(STR("__vecDelDtor_3")); it == FNumericProperty::VTableLayoutMap.end())
{
    FNumericProperty::VTableLayoutMap.emplace(STR("__vecDelDtor_3"), 0x0);
}
...
{
    FNumericProperty::VTableLayoutMap.emplace(STR("SetIntPropertyValue"), 0x180);
}

if (auto it = FNumericProperty::VTableLayoutMap.find(STR("SetIntPropertyValue_2")); it == FNumericProperty::VTableLayoutMap.end())
{
    FNumericProperty::VTableLayoutMap.emplace(STR("SetIntPropertyValue_2"), 0x188);
}
