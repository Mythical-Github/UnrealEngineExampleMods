...
{
    FArchiveState::VTableLayoutMap.emplace(STR("CountBytes"), 0x8);
}

if (auto it = FArchiveState::VTableLayoutMap.find(STR("GetArchiveName")); it == FArchiveState::VTableLayoutMap.end())
{
    FArchiveState::VTableLayoutMap.emplace(STR("GetArchiveName"), 0x10);
}

if (auto it = FArchiveState::VTableLayoutMap.find(STR("GetLinker")); it == FArchiveState::VTableLayoutMap.end())
{
    FArchiveState::VTableLayoutMap.emplace(STR("GetLinker"), 0x18);
}

if (auto it = FArchiveState::VTableLayoutMap.find(STR("Tell")); it == FArchiveState::VTableLayoutMap.end())
{
    FArchiveState::VTableLayoutMap.emplace(STR("Tell"), 0x20);
}

if (auto it = FArchiveState::VTableLayoutMap.find(STR("TotalSize")); it == FArchiveState::VTableLayoutMap.end())
{
    FArchiveState::VTableLayoutMap.emplace(STR("TotalSize"), 0x28);
}

if (auto it = FArchiveState::VTableLayoutMap.find(STR("AtEnd")); it == FArchiveState::VTableLayoutMap.end())
{
    FArchiveState::VTableLayoutMap.emplace(STR("AtEnd"), 0x30);
}

if (auto it = FArchiveState::VTableLayoutMap.find(STR("GetError")); it == FArchiveState::VTableLayoutMap.end())
{
    FArchiveState::VTableLayoutMap.emplace(STR("GetError"), 0x38);
}
