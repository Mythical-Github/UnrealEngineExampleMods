...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetPriority"), 0x348);
}

if (auto it = AActor::VTableLayoutMap.find(STR("GetNetPriority_2")); it == AActor::VTableLayoutMap.end())
{
    AActor::VTableLayoutMap.emplace(STR("GetNetPriority_2"), 0x350);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetDormancy"), 0x360);
}

if (auto it = AActor::VTableLayoutMap.find(STR("GetNetDormancy_2")); it == AActor::VTableLayoutMap.end())
{
    AActor::VTableLayoutMap.emplace(STR("GetNetDormancy_2"), 0x368);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("IsNetRelevantFor"), 0x3F8);
}

if (auto it = AActor::VTableLayoutMap.find(STR("IsNetRelevantFor_2")); it == AActor::VTableLayoutMap.end())
{
    AActor::VTableLayoutMap.emplace(STR("IsNetRelevantFor_2"), 0x400);
}
