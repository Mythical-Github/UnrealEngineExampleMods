...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("PreLogin"), 0x700);
}

if (auto it = AGameModeBase::VTableLayoutMap.find(STR("PreLogin_2")); it == AGameModeBase::VTableLayoutMap.end())
{
    AGameModeBase::VTableLayoutMap.emplace(STR("PreLogin_2"), 0x708);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("Login_2"), 0x718);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("InitNewPlayer"), 0x788);
}

if (auto it = AGameModeBase::VTableLayoutMap.find(STR("InitNewPlayer_2")); it == AGameModeBase::VTableLayoutMap.end())
{
    AGameModeBase::VTableLayoutMap.emplace(STR("InitNewPlayer_2"), 0x790);
}
