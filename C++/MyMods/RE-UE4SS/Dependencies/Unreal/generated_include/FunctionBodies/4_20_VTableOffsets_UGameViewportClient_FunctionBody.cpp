...
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("AddViewportWidgetContent"), 0x268);
}
...
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("RemoveViewportWidgetContent"), 0x270);
}
...
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("AddViewportWidgetForPlayer"), 0x278);
}
...
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("SetupInitialLocalPlayer"), 0x2B8);
}
