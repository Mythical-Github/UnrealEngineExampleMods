...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetPriority"), 0x368);
}

if (auto it = AActor::VTableLayoutMap.find(STR("GetNetPriority_2")); it == AActor::VTableLayoutMap.end())
{
    AActor::VTableLayoutMap.emplace(STR("GetNetPriority_2"), 0x370);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetDormancy"), 0x380);
}

if (auto it = AActor::VTableLayoutMap.find(STR("GetNetDormancy_2")); it == AActor::VTableLayoutMap.end())
{
    AActor::VTableLayoutMap.emplace(STR("GetNetDormancy_2"), 0x388);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("IsNetRelevantFor"), 0x418);
}

if (auto it = AActor::VTableLayoutMap.find(STR("IsNetRelevantFor_2")); it == AActor::VTableLayoutMap.end())
{
    AActor::VTableLayoutMap.emplace(STR("IsNetRelevantFor_2"), 0x420);
}
